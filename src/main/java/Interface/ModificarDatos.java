...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //todos los datos del papa
        String nombre_Papa = txtNombrePapa.getText();
        String cel_Papa = txtNumCel.getText();

        control.modificarAlumno(alumno, nombreAlumno, apellido, dni, curso, direccion, fechaNac, sexo, turno, nombre_Papa, cel_Papa);

        //mensaje q salio todo bien 
    ...
    private void cargarDatos(int num_alumno) {
        //se cargan los datos que trae de la BD a la pantalla editar
        this.alumno = control.traerAlumno(num_alumno);
        ...
        txtFechaNac.setText(alumno.getFecha_nac());
        txtSexo.setText(alumno.getSexo());
        txtTurno.setText(alumno.getTurno());
        txtNombrePapa.setText(alumno.getUnPapa().getNombre_Papa());
        txtNumCel.setText(alumno.getUnPapa().getCel_Papa());
